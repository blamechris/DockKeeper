...
- Every worker brief is **self-contained**: repo context, exact scope, house style, what NOT to touch, the return format, and the project's exploration shortcut (no code-intelligence MCP in this repo — Read/grep directly; docs/behavior-specification.md and docs/technical-design.md are the fastest map of intent before diving into Sources/).
